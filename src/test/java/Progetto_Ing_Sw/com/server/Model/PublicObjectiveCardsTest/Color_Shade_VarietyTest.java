...
import Progetto_Ing_Sw.com.server.Model.PublicObjectiveCards.ColorVariety;
import Progetto_Ing_Sw.com.server.Model.PublicObjectiveCards.ShadeVariety;
...
public class Color_Shade_VarietyTest {

    private WindowBoard windowBoard;
    private ColorVariety colorVariety;
    private ShadeVariety shadeVariety;
    private Dice dice1;
    private Dice dice2;
    private Dice dice3;
    private Dice dice4;
    ...
    public void before() {
        ...
        colorVariety = mock(ColorVariety.class);
        shadeVariety = mock(ShadeVariety.class);
    ...
    public void countPoints() throws ShadeNotEqualException, AdjacencyException, OccupiedCellException, ColorNotEqualException, AdjacencyBreakerException, OrthogonalColorException, OrthogonalValueException, NotOnBordersException {
        ...
        ColorVariety colorVariety = new ColorVariety();
        ...
        System.out.println("Color Variety ==>"+colorVariety.calculatePoints(boardPlayerOne));
        System.out.println("Shade Variety ==>"+shadeVariety.calculatePoints(boardPlayerOne));
        System.out.println();
